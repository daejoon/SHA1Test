...
public final class SHA1 {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
        File file1 = new File("./data/test1.txt");
        File file2 = new File("./data/test2.txt");

        String result1 = encryptSHA1(new FileInputStream(file1));
        System.out.println("result1: " + result1);

        String result2 = encryptSHA1(new FileInputStream(file2));
